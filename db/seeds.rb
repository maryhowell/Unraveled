...
pattern12 = Pattern.create!(
  seller_id: user6.id,
  name: "Ronan",
  image_url: ["https://images4-e.ravelrycache.com/uploads/brooklyntweed/451972255/ronan_01_medium2.jpg"],
...
pattern13 = Pattern.create!(
  seller_id: user5.id,
  name: "Ilia",
  image_url: ["https://images4-e.ravelrycache.com/uploads/brooklyntweed/421488166/ilia_01_medium2.jpg"],
...
pattern14 = Pattern.create!(
  seller_id: user4.id,
  name: "Prime",
  image_url: ["https://images4-e.ravelrycache.com/uploads/brooklyntweed/413604097/prime_01_medium2.jpg"],
...
pattern15 = Pattern.create!(
  seller_id: user2.id,
  name: "Binary",
  image_url: ["https://images4-e.ravelrycache.com/uploads/brooklyntweed/413577795/binary_01_medium2.jpg"],
...
pattern16 = Pattern.create!(
  seller_id: user1.id,
  name: "Foundry",
  image_url: ["https://images4-b.ravelrycache.com/uploads/brooklyntweed/401948956/foundry_2_medium2.jpg"],
...
pattern17 = Pattern.create!(
  seller_id: user4.id,
  name: "Furrow Cowl",
  image_url: ["https://images4-e.ravelrycache.com/uploads/brooklyntweed/389995897/furrow_cowl_02_medium2.jpg"],
...
pattern18 = Pattern.create!(
  seller_id: user3.id,
  name: "Tessera",
  image_url: ["https://images4-e.ravelrycache.com/uploads/brooklyntweed/390294274/tessera_01_medium2.jpg"],
...
pattern19 = Pattern.create!(
  seller_id: user6.id,
  name: "Halus",
  image_url: ["https://images4-e.ravelrycache.com/uploads/brooklyntweed/348518569/Halus_01_medium2.jpg"],
...
patter20 = Pattern.create!(
  seller_id: user7.id,
  name: "League",
  image_url: ["https://images4-e.ravelrycache.com/uploads/brooklyntweed/348497753/League_01_medium2.jpg"],
